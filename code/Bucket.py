...
class bucket(object):
		def __init__(self):
				...
				self.anim_image_left = Utils.load_image("images/Papierkorb.png", (0, 0, 0))
				self.anim_left = Animation.Animation(self.anim_image_left, 0, 0, 1, 62, 124, 10)	
				...
				self.anim_right = Animation.Animation(self.anim_image_right, 0, 0, 1, 62, 124, 10)
